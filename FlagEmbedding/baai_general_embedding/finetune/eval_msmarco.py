...
def main():
    ...
    eval_data = datasets.load_dataset(f"/home/tongyan.zjy/hf_hub/datasets--namespace-Pt--msmarco", split="dev")
    corpus = datasets.load_dataset(f"/home/tongyan.zjy/hf_hub/datasets--namespace-Pt--msmarco-corpus", split="train")
